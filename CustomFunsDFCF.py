...
updated @ 2022-05-18
0.  explanation for Pycharm Error: Could not find reference "urllib3"
    *** PYCHARM IS WRONG HERE *** 
    this path does exist. But it's added dynamically, which may cause PyCharm some problems. 
    I recommend opening a bug report with PyCharm.
"""
